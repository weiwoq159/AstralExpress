...
import { listCrawlersResponse, listTasksResponse } from "./commands.mock";

const MODULE_ID = "crawler";

export const listCrawlers = async (): Promise<Manifest[]> => {
  if (!isTauri()) {
    return Promise.resolve(listCrawlersResponse);
  }
